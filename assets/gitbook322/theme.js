!function e(t, n, r) {
    function o(a, s) {
        if (!n[a]) {
            if (!t[a]) {
                ...
                let l = new Error('Cannot find module \'' + a + '\'');
    ...
    1: [function (e, t, n) {
        !function (e, n) {
            ...
            function d(e, t, n, r) {
                ...
                let u = s();
                let l = n && n[3] || (de.cssNumber[t] ? '' : 'px');
                let c = (de.cssNumber[t] || 'px' !== l && +u) && $e.exec(de.css(e, t));
                if (c && c[3] !== l) {
                    l = l || c[3], n = n || [], c = +u || 1;
                    do {
                        i = i || '.5', c /= i, de.style(e, t, c + l);
                    } while (i !== (i = s() / u) && 1 !== i && --a);
                }
            ...
            function m(e, t) {
                for (var n, r, o = [], i = 0, a = e.length; i < a; i++) {
                    r = e[i], r.style && (n = r.style.display, t ? ('none' === n && (o[i] = Fe.get(r, 'display') || null, o[i] || (r.style.display = '')), '' === r.style.display && We(r) && (o[i] = g(r))) : 'none' !== n && (o[i] = 'none', Fe.set(r, 'display', n)));
                }
                for (i = 0; i < a; i++) {
                ...
                for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], h = 0, d = e.length; h < d; h++) {
                    if (i = e[h], i || 0 === i) {
                        if ('object' === de.type(i)) {
                            ...
                            for (a = a || f.appendChild(t.createElement('div')), s = (Xe.exec(i) || ['', ''])[1].toLowerCase(), u = Ve[s] || Ve._default, a.innerHTML = u[1] + de.htmlPrefilter(i) + u[2], c = u[0]; c--;) {
                                a = a.lastChild;
                            }
            ...
            function E(e) {
                let t = rt.exec(e.type);
                return t ? e.type = t[1] : e.removeAttribute('type'), e;
            }

            function N(e, t) {
                let n; let r; let o; let i; let a; let s; let u; let l;
                if (1 === t.nodeType) {
            ...
            function A(e, t, r, o) {
                t = oe.apply([], t);
                let i; let a; let s; let u; let l; let c; let f = 0;
                let p = e.length;
                let h = p - 1;
                let d = t[0];
                let g = de.isFunction(d);
                ...
                if (p && (i = b(t, e[0].ownerDocument, !1, e, o), a = i.firstChild, 1 === i.childNodes.length && (i = a), a || o)) {
                    for (s = de.map(v(i, 'script'), j), u = s.length; f < p; f++) {
                        l = i, f !== h && (l = de.clone(l, !0, !0), u && de.merge(s, v(l, 'script'))), r.call(e[f], l, f);
                    }
                    if (u) {
                        for (c = s[s.length - 1].ownerDocument, de.map(s, E), f = 0; f < u; f++) {
                            l = s[f], Ke.test(l.type || '') && !Fe.access(l, 'globalEval') && de.contains(c, l) && (l.src ? de._evalUrl && de._evalUrl(l.src) : n(l.textContent.replace(ot, ''), c));
                        }
                    }
                }
                return e;
            ...
            function q(e, t, n) {
                for (var r, o = t ? de.filter(t, e) : e, i = 0; null != (r = o[i]); i++) {
                    n || 1 !== r.nodeType || de.cleanData(v(r)), r.parentNode && (n && de.contains(r.ownerDocument, r) && y(v(r, 'script')), r.parentNode.removeChild(r));
                }
                return e;
            }

            function D(e, t, n) {
                let r; let o; let i; let a; let s = e.style;
            ...
            function L(e) {
                ...
                for (let t = e[0].toUpperCase() + e.slice(1), n = ft.length; n--;) {
                    if (e = ft[n] + t, e in pt) {
                        return e;
                    }
                }
            ...
            function F(e, t, n, r, o) {
                ...
                for (i = n === (r ? 'border' : 'content') ? 4 : 'width' === t ? 1 : 0; i < 4; i += 2) {
                    'margin' === n && (a += de.css(e, n + _e[i], !0, o)), r ? ('content' === n && (a -= de.css(e, 'padding' + _e[i], !0, o)), 'margin' !== n && (a -= de.css(e, 'border' + _e[i] + 'Width', !0, o))) : (a += de.css(e, 'padding' + _e[i], !0, o), 'padding' !== n && (a += de.css(e, 'border' + _e[i] + 'Width', !0, o)));
                }
                return a;
            }
            ...
            function P(e, t, n) {
                let r; let o = !0;
                let i = st(e);
                let a = 'border-box' === de.css(e, 'boxSizing', !1, i);
                if (e.getClientRects().length && (r = e.getBoundingClientRect()[t]), r <= 0 || null == r) {
                    if (r = D(e, t, i), (r < 0 || null == r) && (r = e.style[t]), at.test(r)) {
                        return r;
                    }
            ...
            function W(e, t, n) {
                let r; let o; let i; let a; let s; let u; let l; let c; let f = 'width' in t || 'height' in t;
                let p = this;
                let h = {};
                let d = e.style;
                let g = e.nodeType && We(e);
                let v = Fe.get(e, 'fxshow');
            ...
            function U(e, t, n) {
                let r; let o; let i = 0;
                let a = U.prefilters.length;
                let s = de.Deferred().always(function () {
                    delete u.elem;
                });
                var u = function () {
                    if (o) {
                ...
                var l = s.promise({
                    ...
                    createTween: function (t, n) {
                        let r = de.Tween(e, l.opts, t, n, l.opts.specialEasing[t] || l.opts.easing);
                        return l.tweens.push(r), r;
                    },
                    stop: function (t) {
                        let n = 0;
                        let r = t ? l.tweens.length : 0;
                        if (o) {
                            return this;
                        }
                        for (o = !0; n < r; n++) {
                ...
                for (B(c, l.opts.specialEasing); i < a; i++) {
                    if (r = U.prefilters[i].call(l, e, c, l.opts)) {
                        return de.isFunction(r.stop) && (de._queueHooks(l.elem, l.opts.queue).stop = de.proxy(r.stop, r)), r;
                    }
                }
            ...
            function Y(e, t) {
                let n; let r; let o = de.ajaxSettings.flatOptions || {};
                for (n in t) {
            ...
            function J(e, t, n, r) {
                let o; let i; let a; let s; let u; let l = {};
            ...
            let se = {};
            let ue = se.toString;
            let le = se.hasOwnProperty;
            let ce = le.toString;
            let fe = ce.call(Object);
            var pe = {};
            let he = '3.1.1';
            var de = function (e, t) {
                return new de.fn.init(e, t);
            };
            let ge = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
            let me = /^-ms-/;
            let ve = /-([a-z])/g;
            let ye = function (e, t) {
            ...
            de.fn = de.prototype = {
                ...
                pushStack: function (e) {
                    let t = de.merge(this.constructor(), e);
                ...
                let e; let t; let n; let r; let o; let i; let a = arguments[0] || {};
                let s = 1;
                ...
                for ('boolean' === typeof a && (l = a, a = arguments[s] || {}, s++), 'object' === typeof a || de.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++) {
                    if (null != (e = arguments[s])) {
                        for (t in e) {
                            n = a[t], r = e[t], a !== r && (l && r && (de.isPlainObject(r) || (o = de.isArray(r))) ? (o ? (o = !1, i = n && de.isArray(n) ? n : []) : i = n && de.isPlainObject(n) ? n : {}, a[t] = de.extend(l, i, r)) : void 0 !== r && (a[t] = r));
                        }
                    }
                }
                return a;
                ...
                proxy: function (e, t) {
                    ...
                    if ('string' === typeof t && (n = e[t], t = e, e = n), de.isFunction(e)) {
                        return r = re.call(arguments, 2), o = function () {
            ...
            let be = function (e) {
                function t(e, t, n, r) {
                    let o; let i; let a; let s; let u; let l; let c; let p = t && t.ownerDocument;
                    let d = t ? t.nodeType : 9;
                    ...
                    if (!r && ((t ? t.ownerDocument || t : _) !== L && O(t), t = t || L, F)) {
                        if (11 !== d && (u = ve.exec(e))) {
                            ...
                            if (1 !== d) {
                                ...
                                for ((s = t.getAttribute('id')) ? s = s.replace(we, Ce) : t.setAttribute('id', s = $), l = E(e), i = l.length; i--;) {
                                    l[i] = '#' + s + ' ' + h(l[i]);
                                }
                ...
                function o(e) {
                    let t = L.createElement('fieldset');
                    try {
                        return !!e(t);
                    } catch (e) {
                        return !1;
                ...
                function a(e, t) {
                    let n = t && e;
                    let r = n && 1 === e.nodeType && 1 === t.nodeType && e.sourceIndex - t.sourceIndex;
                    if (r) {
                        return r;
                    }
                    if (n) {
                ...
                function d(e, t, n) {
                    ...
                    return t.first ? function (t, n, o) {
                        ...
                        if (u) {
                            ...
                            for (; t = t[r];) {
                                if (1 === t.nodeType || a) {
                                    if (f = t[$] || (t[$] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) {
                                        t = t[r] || t;
                                    } else {
                                        if ((l = c[i]) && l[0] === W && l[1] === s) {
                                            return p[2] = l[2];
                                        }
                                        if (c[i] = p, p[2] = e(t, n, u)) {
                                            return !0;
                                        }
                                    }
                                }
                ...
                function y(e, t, n, o, i, a) {
                    return o && !o[$] && (o = y(o)), i && !i[$] && (i = y(i, a)), r(function (r, a, s, u) {
                        let l; let c; let f; let p = [];
                        let h = [];
                        let d = a.length;
                        let g = r || m(t || '*', s.nodeType ? [s] : s, []);
                        let y = !e || !r && t ? g : v(g, p, e, s, u);
                        let b = n ? i || (r ? e : d || o) ? [] : a : y;
                        if (n && n(y, b, s, u), o) {
                            for (l = v(b, h), o(l, [], s, u), c = l.length; c--;){
                                (f = l[c]) && (b[h[c]] = !(y[h[c]] = f));
                            }
                        }
                        if (r) {
                            ...
                            b = v(b === a ? b.splice(d, b.length) : b), i ? i(null, a, b, u) : J.apply(a, b);
                        }
                    });
                }
                ...
                function b(e) {
                    for (var t, n, r, o = e.length, i = T.relative[e[0].type], a = i || T.relative[' '], s = i ? 1 : 0, u = d(function (e) {
                            ...
                            let o = !i && (r || n !== A) || ((t = n).nodeType ? u(e, n, r) : l(e, n, r));
                            return t = null, o;
                        }]; s < o; s++) {
                ...
                function x(e, n) {
                    let o = n.length > 0;
                    let i = e.length > 0;
                    let a = function (r, a, s, u, l) {
                        let c; let f; let p; let h = 0;
                        let d = '0';
                        let g = r && [];
                        let m = [];
                        let y = A;
                        let b = r || i && T.find.TAG('*', l);
                        let x = W += null == y ? 1 : Math.random() || .1;
                        let w = b.length;
                ...
                let w; let C; let T; let k; let j; let E; let N; let S; let A; let q; let D; let O; let L; let H; let F; let P; let I; let R; let M; var $ = 'sizzle' + 1 * new Date;
                var _ = e.document;
                var W = 0;
                var B = 0;
                let U = n();
                ...
                let te = 'checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped';
                let ne = '[\\x20\\t\\r\\n\\f]';
                let re = '(?:\\\\.|[\\w-]|[^\0-\\xa0])+';
                let oe = '\\[' + ne + '*(' + re + ')(?:' + ne + '*([*^$|!~]?=)' + ne + '*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|(' + re + '))|)' + ne + '*\\]';
                let ie = ':(' + re + ')(?:\\(((\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|' + oe + ')*)|.*)\\)|)';
                let ae = new RegExp(ne + '+', 'g');
                var se = new RegExp('^' + ne + '+|((?:^|[^\\\\])(?:\\\\.)*)' + ne + '+$', 'g');
                let ue = new RegExp('^' + ne + '*,' + ne + '*');
                let le = new RegExp('^' + ne + '*([>+~]|' + ne + ')' + ne + '*');
                let ce = new RegExp('=' + ne + '*([^\\]\'"]*?)' + ne + '*\\]', 'g');
                let fe = new RegExp(ie);
                let pe = new RegExp('^' + re + '$');
                let he = {
                    ID: new RegExp('^#(' + re + ')'),
                    CLASS: new RegExp('^\\.(' + re + ')'),
                    TAG: new RegExp('^(' + re + '|[*])'),
                ...
                let de = /^(?:input|select|textarea|button)$/i;
                let ge = /^h\d$/i;
                let me = /^[^{]+\{\s*\[native \w/;
                var ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
                var ye = /[+~]/;
                let be = new RegExp('\\\\([\\da-f]{1,6}' + ne + '?|(' + ne + ')|.)', 'ig');
                let xe = function (e, t, n) {
                    let r = '0x' + t - 65536;
                    return r !== r || n ? t : r < 0 ? String.fromCharCode(r + 65536) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320);
                };
                var we = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g;
                var Ce = function (e, t) {
                ...
                C = t.support = {}, j = t.isXML = function (e) {
                    ...
                    let t; let n; let r = e ? e.ownerDocument || e : _;
                    return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = L.documentElement, F = !j(L), _ !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener('unload', Te, !1) : n.attachEvent && n.attachEvent('onunload', Te)), C.attributes = o(function (e) {
                        ...
                        let n; let r = [];
                        let o = 0;
                        let i = t.getElementsByTagName(e);
                        if ('*' === e) {
                            for (; n = i[o++];) {
                    ...
                    if ((e.ownerDocument || e) !== L && O(e), n = n.replace(ce, '=\'$1\']'), C.matchesSelector && F && !X[n + ' '] && (!I || !I.test(n)) && (!P || !P.test(n))) {
                        try {
                            let r = R.call(e, n);
                    ...
                    let n = T.attrHandle[t.toLowerCase()];
                    let r = n && V.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !F) : void 0;
                    ...
                    filter: {
                        TAG: function (e) {
                            let t = e.replace(be, xe).toLowerCase();
                            return '*' === e ? function () {
                                return !0;
                            } : function (e) {
                        ...
                        CHILD: function (e, t, n, r, o) {
                            let i = 'nth' !== e.slice(0, 3);
                            let a = 'last' !== e.slice(-4);
                            let s = 'of-type' === t;
                            return 1 === r && 0 === o ? function (e) {
                                return !!e.parentNode;
                            } : function (t, n, u) {
                                let l; let c; let f; let p; let h; let d; let g = i !== a ? 'nextSibling' : 'previousSibling';
                                let m = t.parentNode;
                        ...
                        PSEUDO: function (e, n) {
                            let o; let i = T.pseudos[e] || T.setFilters[e.toLowerCase()] || t.error('unsupported pseudo: ' + e);
                ...
                return p.prototype = T.filters = T.pseudos, T.setFilters = new p, E = t.tokenize = function (e, n) {
                    let r; let o; let i; let a; let s; let u; let l; let c = z[e + ' '];
                    if (c) {
                    ...
                    for (s = e, u = [], l = T.preFilter; s;) {
                        ...
                        for (a in T.filter) {
                            !(o = he[a].exec(s)) || l[a] && !(o = l[a](o)) || (r = o.shift(), i.push({
                                value: r,
                                type: a,
                                matches: o
                            }), s = s.slice(r.length));
                    ...
                    let o; let i; let a; let s; let u; let l = 'function' === typeof e && e;
                    let c = !r && E(e = l.selector || e);
                    if (n = n || [], 1 === c.length) {
            ...
            let Ce = de.expr.match.needsContext;
            let Te = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
            var ke = /^.[^:#\[\.,]*$/;
            ...
            let je; let Ee = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
            let Ne = de.fn.init = function (e, t, n) {
                let r; let o;
                if (!e) {
                    return this;
                }
                if (n = n || je, 'string' === typeof e) {
                    if (r = '<' === e[0] && '>' === e[e.length - 1] && e.length >= 3 ? [null, e, null] : Ee.exec(e), !r || !r[1] && t) {
            ...
            de.Callbacks = function (e) {
                ...
                let t; let n; let r; let o; let i = [];
                let s = [];
                let u = -1;
                let l = function () {
                    for (o = e.once, r = t = !0; s.length; u = -1) {
                        for (n = s.shift(); ++u < i.length;) {
                            i[u].apply(n[0], n[1]) === !1 && e.stopOnFalse && (u = i.length, n = !1);
                        }
                    }
                    ...
                    var o = {
                        ...
                        pipe: function () {
                            ...
                            return de.Deferred(function (t) {
                                de.each(n, function (n, r) {
                                    let o = de.isFunction(e[r[4]]) && e[r[4]];
                                    i[r[1]](function () {
                                        let e = o && o.apply(this, arguments);
                ...
                when: function (e) {
                    ...
                    if (t <= 1 && (l(e, i.done(a(n)).resolve, i.reject), 'pending' === i.state() || de.isFunction(o[n] && o[n].then))) {
                        return i.then();
                    }
                    for (; n--;) {
                        l(o[n], a(n), i.reject);
            ...
            let De = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
            ...
            de.extend({
                ...
                data: function (e, t) {
                    let n; let r; let o; let i = this[0];
                    let a = i && i.attributes;
                    if (void 0 === e) {
                        if (this.length && (o = Pe.get(i), 1 === i.nodeType && !Fe.get(i, 'hasDataAttrs'))) {
                            for (n = a.length; n--;) {
                                a[n] && (r = a[n].name, 0 === r.indexOf('data-') && (r = de.camelCase(r.slice(5)), h(i, r, o[r])));
                            }
                ...
                queue: function (e, t, n) {
                    let r;
                    if (e) {
                        return t = (t || 'fx') + 'queue', r = Fe.get(e, t), n && (!r || de.isArray(n) ? r = Fe.access(e, t, de.makeArray(n)) : r.push(n)), r || [];
                    }
                },
                ...
                promise: function (e, t) {
                    ...
                    for ('string' !== typeof e && (t = e, e = void 0), e = e || 'fx'; a--;) {
                        n = Fe.get(i[a], e + 'queueHooks'), n && n.empty && (r++, n.empty.add(s));
                    }
                    return s(), o.promise(t);
                }
            });
            let Me = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source;
            var $e = new RegExp('^(?:([+-])=|)(' + Me + ')([a-z%]*)$', 'i');
            ...
            var Ge = /<|&#?\w+;/;
            !function () {
                let e = te.createDocumentFragment();
                let t = e.appendChild(te.createElement('div'));
                let n = te.createElement('input');
                n.setAttribute('type', 'radio'), n.setAttribute('checked', 'checked'), n.setAttribute('name', 't'), t.appendChild(n), pe.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, t.innerHTML = '<textarea>x</textarea>', pe.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue;
            }();
            let Ye = te.documentElement;
            let Qe = /^key/;
            let Je = /^(?:mouse|pointer|contextmenu|drag|drop)|click/;
            let Ze = /^([^.]*)(?:\.(.+)|)/;
            de.event = {
                global: {},
                add: function (e, t, n, r, o) {
                    let i; let a; let s; let u; let l; let c; let f; let p; let h; let d; let g; let m = Fe.get(e);
                    if (m) {
                        for (n.handler && (i = n, n = i.handler, o = i.selector), o && de.find.matchesSelector(Ye, o), n.guid || (n.guid = de.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function (t) {
                            ...
                            s = Ze.exec(t[l]) || [], h = g = s[1], d = (s[2] || '').split('.').sort(), h && (f = de.event.special[h] || {}, h = (o ? f.delegateType : f.bindType) || h, f = de.event.special[h] || {}, c = de.extend({
                                type: h,
                                origType: g,
                                data: r,
                                handler: n,
                ...
                remove: function (e, t, n, r, o) {
                    let i; let a; let s; let u; let l; let c; let f; let p; let h; let d; let g; let m = Fe.hasData(e) && Fe.get(e);
                    if (m && (u = m.events)) {
                        for (t = (t || '').match(qe) || [''], l = t.length; l--;) {
                            if (s = Ze.exec(t[l]) || [], h = g = s[1], d = (s[2] || '').split('.').sort(), h) {
                                for (f = de.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, p = u[h] || [], s = s[2] && new RegExp('(^|\\.)' + d.join('\\.(?:.*\\.|)') + '(\\.|$)'), a = i = p.length; i--;) {
                ...
                dispatch: function (e) {
                    let t; let n; let r; let o; let i; let a; let s = de.event.fix(e);
                    let u = new Array(arguments.length);
                    let l = (Fe.get(this, 'events') || {})[s.type] || [];
                    let c = de.event.special[s.type] || {};
                    ...
                    if (s.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, s) !== !1) {
                        for (a = de.event.handlers.call(this, s, l), t = 0;
                            ...
                            for (s.currentTarget = o.elem, n = 0;
                                ...
                                s.rnamespace && !s.rnamespace.test(i.namespace) || (s.handleObj = i, s.data = i.data, r = ((de.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u), void 0 !== r && (s.result = r) === !1 && (s.preventDefault(), s.stopPropagation()));
                            }
                        }
                ...
                handlers: function (e, t) {
                    let n; let r; let o; let i; let a; let s = [];
                    let u = t.delegateCount;
                    let l = e.target;
                    if (u && l.nodeType && !('click' === e.type && e.button >= 1)) {
                        for (; l !== this; l = l.parentNode || this) {
                            if (1 === l.nodeType && ('click' !== e.type || l.disabled !== !0)) {
                                for (i = [], a = {}, n = 0; n < u; n++) {
                                    r = t[n], o = r.selector + ' ', void 0 === a[o] && (a[o] = r.needsContext ? de(o, this).index(l) > -1 : de.find(o, this, null, [l]).length), a[o] && i.push(r);
                                }
                                i.length && s.push({
                                    elem: l,
                                    handlers: i
            ...
            let et = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi;
            let tt = /<script|<style|<link/i;
            ...
            de.extend({
                ...
                clone: function (e, t, n) {
                    let r; let o; let i; let a; let s = e.cloneNode(!0);
                    let u = de.contains(e.ownerDocument, e);
                    if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e))) {
                        for (a = v(s), i = v(e), r = 0, o = i.length; r < o; r++) {
                            S(i[r], a[r]);
                        }
                    }
                    if (t) {
                        if (n) {
                            for (i = i || v(e), a = a || v(s), r = 0, o = i.length; r < o; r++) {
                                N(i[r], a[r]);
                            }
                        } else {
                            N(e, s);
                ...
                empty: function () {
                    for (var e, t = 0; null != (e = this[t]); t++) {
                        1 === e.nodeType && (de.cleanData(v(e, !1)), e.textContent = '');
                    }
                    return this;
                },
                clone: function (e, t) {
                ...
                html: function (e) {
                    return Le(this, function (e) {
                        ...
                        if ('string' === typeof e && !tt.test(e) && !Ve[(Xe.exec(e) || ['', ''])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; n < r; n++) {
                                    t = this[n] || {}, 1 === t.nodeType && (de.cleanData(v(t, !1)), t.innerHTML = e);
                                }
                                t = 0;
                            } catch (e) {}
                        }
                ...
                de.fn[e] = function (e) {
                    for (var n, r = [], o = de(e), i = o.length - 1, a = 0; a <= i; a++) {
                        n = a === i ? this : this.clone(!0), de(o[a])[t](n), ie.apply(r, n.get());
                    }
                    return this.pushStack(r);
                };
            });
            var it = /^margin/;
            var at = new RegExp('^(' + Me + ')(?!px)[a-z%]+$', 'i');
            var st = function (t) {
            ...
            var pt = te.createElement('div').style;
            de.extend({
                cssHooks: {
                    opacity: {
                        get: function (e, t) {
                ...
                style: function (e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        let o; let i; let a; let s = de.camelCase(t);
                        let u = e.style;
                ...
                de.cssHooks[t] = {
                    ...
                    set: function (e, n, r) {
                        let o; let i = r && st(e);
                        let a = r && F(e, t, r, 'border-box' === de.css(e, 'boxSizing', !1, i), i);
                ...
                cur: function () {
                    let e = I.propHooks[this.prop];
                    return e && e.get ? e.get(this) : I.propHooks._default.get(this);
                },
                run: function (e) {
                    let t; let n = I.propHooks[this.prop];
            ...
            let ht; let dt; var gt = /^(?:toggle|show|hide)$/;
            let mt = /queueHooks$/;
            de.Animation = de.extend(U, {
                ...
                let r = e && 'object' === typeof e ? de.extend({}, e) : {
                ...
                animate: function (e, t, n, r) {
                    let o = de.isEmptyObject(e);
                    let i = de.speed(t, n, r);
                    let a = function () {
                        let t = U(this, de.extend({}, e), i);
                ...
                finish: function (e) {
                    return e !== !1 && (e = e || 'fx'), this.each(function () {
                        let t; let n = Fe.get(this);
                        let r = n[e + 'queue'];
                        let o = n[e + 'queueHooks'];
                        let i = de.timers;
                        let a = r ? r.length : 0;
                        for (n.finish = !0, de.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = i.length; t--;) {
            ...
            function () {
                let e = te.createElement('input');
                let t = te.createElement('select');
                let n = t.appendChild(te.createElement('option'));
            ...
            let vt; let yt = de.expr.attrHandle;
            de.fn.extend({
                attr: function (e, t) {
                ...
                attr: function (e, t, n) {
                    let r; let o; let i = e.nodeType;
                    if (3 !== i && 8 !== i && 2 !== i) {
                        return 'undefined' === typeof e.getAttribute ? de.prop(e, t, n) : (1 === i && de.isXMLDoc(e) || (o = de.attrHooks[t.toLowerCase()] || (de.expr.match.bool.test(t) ? vt : void 0)), void 0 !== n ? null === n ? void de.removeAttr(e, t) : o && 'set' in o && void 0 !== (r = o.set(e, n, t)) ? r : (e.setAttribute(t, n + ''), n) : o && 'get' in o && null !== (r = o.get(e, t)) ? r : (r = de.find.attr(e, t), null == r ? void 0 : r));
                    }
                },
                attrHooks: {
                    type: {
                ...
                let n = yt[t] || de.find.attr;
                yt[t] = function (e, t, r) {
                    let o; let i; let a = t.toLowerCase();
            ...
            de.fn.extend({
                ...
                addClass: function (e) {
                    let t; let n; let r; let o; let i; let a; let s; let u = 0;
                    if (de.isFunction(e)) {
                ...
                toggleClass: function (e, t) {
                    ...
                    return 'boolean' === typeof t && 'string' === n ? t ? this.addClass(e) : this.removeClass(e) : de.isFunction(e) ? this.each(function (n) {
                        ...
                        if ('string' === n) {
                            for (r = 0, o = de(this), i = e.match(qe) || []; t = i[r++];) {
                                o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                            }
                        } else {
                            void 0 !== e && 'boolean' !== n || (t = X(this), t && Fe.set(this, '__className__', t), this.setAttribute && this.setAttribute('class', t || e === !1 ? '' : Fe.get(this, '__className__') || ''));
                        }
                    });
                },
                hasClass: function (e) {
            ...
            de.fn.extend({
                val: function (e) {
                    let t; let n; let r; let o = this[0]; {
                        if (arguments.length) {
                            return r = de.isFunction(e), this.each(function (n) {
                                let o;
                ...
                valHooks: {
                    option: {
                        get: function (e) {
                            let t = de.find.attr(e, 'value');
                            return null != t ? t : z(de.text(e));
                        }
                    },
                    select: {
                        get: function (e) {
                            let t; let n; let r; let o = e.options;
                            let i = e.selectedIndex;
                            let a = 'select-one' === e.type;
                            let s = a ? null : [];
                            let u = a ? i + 1 : o.length;
                        ...
                        set: function (e, t) {
                            for (var n, r, o = e.options, i = de.makeArray(t), a = o.length; a--;) {
                                r = o[a], (r.selected = de.inArray(de.valHooks.option.get(r), i) > -1) && (n = !0);
                            }
            ...
            let Ct = /^(?:focusinfocus|focusoutblur)$/;
            de.extend(de.event, {
                trigger: function (t, n, r, o) {
                    let i; let a; let s; let u; let l; let c; let f; let p = [r || te];
                    let h = le.call(t, 'type') ? t.type : t;
                    let d = le.call(t, 'namespace') ? t.namespace.split('.') : [];
                    if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(h + de.event.triggered) && (h.indexOf('.') > -1 && (d = h.split('.'), h = d.shift(), d.sort()), l = h.indexOf(':') < 0 && 'on' + h, t = t[de.expando] ? t : new de.Event(h, 'object' === typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = d.join('.'), t.rnamespace = t.namespace ? new RegExp('(^|\\.)' + d.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : de.makeArray(n, [t]), f = de.event.special[h] || {}, o || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                        ...
                        for (i = 0;
                            (a = p[i++]) && !t.isPropagationStopped();) {
                            t.type = i > 1 ? u : f.bindType || h, c = (Fe.get(a, 'events') || {})[t.type] && Fe.get(a, 'handle'), c && c.apply(a, n), c = l && a[l], c && c.apply && He(a) && (t.result = c.apply(a, n), t.result === !1 && t.preventDefault());
                        }
                ...
                simulate: function (e, t, n) {
                    let r = de.extend(new de.Event, n, {
                        type: e,
                        isSimulated: !0
                    });
            ...
            var Et = /\[\]$/;
            let Nt = /\r?\n/g;
            let St = /^(?:submit|button|image|reset|file)$/i;
            let At = /^(?:input|select|textarea|keygen)/i;
            de.param = function (e, t) {
                let n; let r = [];
                let o = function (e, t) {
                    let n = de.isFunction(t) ? t() : t;
            ...
            let Ot = /([?&])_=[^&]*/;
            let Lt = /^(.*?):[ \t]*([^\r\n]*)$/gm;
            let Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
            let Ft = /^(?:GET|HEAD)$/;
            let Pt = /^\/\//;
            let It = {};
            var Rt = {};
            let Mt = '*/'.concat('*');
            let $t = te.createElement('a');
            $t.href = Tt.href, de.extend({
                ...
                ajax: function (t, n) {
                    function r(t, n, r, s) {
                        let l; let p; let h; let x; let w; let C = n;
                    ...
                    let o; let i; let a; let s; let u; let l; let c; let f; let p; let h; var d = de.ajaxSetup({}, n);
                    var g = d.context || d;
                    var m = d.context && (g.nodeType || g.jquery) ? de(g) : de.event;
                    var v = de.Deferred();
                    var y = de.Callbacks('once memory');
                    var b = d.statusCode || {};
                    let x = {};
                    let w = {};
                    let C = 'canceled';
                    ...
                    if (d.data && d.processData && 'string' !== typeof d.data && (d.data = de.param(d.data, d.traditional)), G(It, d, n, T), c) {
                        return T;
                    }
                    ...
                    if (C = 'abort', y.add(d.complete), T.done(d.success), T.fail(d.error), o = G(Rt, d, n, T)) {
                        if (T.readyState = 1, f && m.trigger('ajaxSend', [T, d]), c) {
                            return T;
                        }
            ...
            de.ajaxSetup({
                ...
                jsonpCallback: function () {
                    let e = Bt.pop() || de.expando + '_' + kt++;
                    return this[e] = !0, e;
                }
            }), de.ajaxPrefilter('json jsonp', function (t, n, r) {
                let o; let i; let a; let s = t.jsonp !== !1 && (Ut.test(t.url) ? 'url' : 'string' === typeof t.data && 0 === (t.contentType || '').indexOf('application/x-www-form-urlencoded') && Ut.test(t.data) && 'data');
                if (s || 'jsonp' === t.dataTypes[0]) {
                    return o = t.jsonpCallback = de.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Ut, '$1' + o) : t.jsonp !== !1 && (t.url += (jt.test(t.url) ? '&' : '?') + t.jsonp + '=' + o), t.converters['script json'] = function () {
                ...
                let e = te.implementation.createHTMLDocument('').body;
                ...
                setOffset: function (e, t, n) {
                    let r; let o; let i; let a; let s; let u; let l; let c = de.css(e, 'position');
                    let f = de(e);
                    let p = {};
                ...
                offset: function (e) {
                    ...
                    let t; let n; let r; let o; let i = this[0];
                    if (i) {
                        return i.getClientRects().length ? (r = i.getBoundingClientRect(), r.width || r.height ? (o = i.ownerDocument, n = Z(o), t = o.documentElement, {
                ...
                de.cssHooks[t] = O(pe.pixelPosition, function (e, n) {
                    if (n) {
                        return n = D(e, t), at.test(n) ? de(e).position()[t] + 'px' : n;
                    }
                });
            }), de.each({
                Height: 'height',
                ...
                de.each({
                    ...
                    de.fn[r] = function (o, i) {
                        let a = arguments.length && (n || 'boolean' !== typeof o);
                        let s = n || (o === !0 || i === !0 ? 'margin' : 'border');
    ...
    2: [function (e, t, n) {
        !function (e, n, r) {
            ...
            function d(e, t) {
                ...
                for (n = h(e), o = 0; o < n.length; ++o) {
                    r = n[o], w[r] && (r = w[r]), t && 'keypress' != t && x[r] && (r = x[r], i.push('shift')), c(r) && i.push(r);
                }
                return t = p(r, i, t), {
                    key: r,
                    modifiers: i,
    ...
    3: [function (e, t, n) {
        (function (e) {
            !function (r) {
                ...
                function f(e, t, n) {
                    let r = 0;
                    for (e = n ? F(e / E) : e >> 1, e += F(e / t); e > H * k >> 1; r += C) {
                        e = F(e / H);
                    }
                ...
                function p(e) {
                    let t; let n; let r; let i; let a; let s; let c; let p; let h; let d; let g = [];
                    let m = e.length;
                    let v = 0;
                    let y = S;
                    let b = N;
                    ...
                    for (i = n > 0 ? n + 1 : 0; i < m;) {
                        for (a = v, s = 1, c = C; i >= m && o('invalid-input'), p = l(e.charCodeAt(i++)), (p >= C || p > F((w - v) / s)) && o('overflow'), v += p * s, h = c <= b ? T : c >= b + k ? k : c - b, !(p < h); c += C) {
                            d = C - h, s > F(w / d) && o('overflow'), s *= d;
                        }
                ...
                function h(e) {
                    let t; let n; let r; let i; let a; let u; let l; let p; let h; let d; let g; let m; let v; let y; let b; let x = [];
                    for (e = s(e), m = e.length, t = S, n = 0, a = N, u = 0; u < m; ++u) {
                    ...
                    for (r = i = x.length, i && x.push(A); r < m;) {
                        ...
                        for (v = r + 1, l - t > F((w - n) / v) && o('overflow'), n += (l - t) * v, t = l, u = 0; u < m; ++u) {
                            if (g = e[u], g < t && ++n > w && o('overflow'), g == t) {
                                for (p = n, h = C; d = h <= a ? T : h >= a + k ? k : h - a, !(p < d); h += C) {
                                    b = p - d, y = C - d, x.push(P(c(d + b % y, 0))), p = F(b / y);
                                }
                ...
                let m = 'object' === typeof n && n && !n.nodeType && n;
                let v = 'object' === typeof t && t && !t.nodeType && t;
                let y = 'object' === typeof e && e;
                y.global !== y && y.window !== y && y.self !== y || (r = y);
                let b; let x; var w = 2147483647;
                var C = 36;
                var T = 1;
                var k = 26;
                var j = 38;
    ...
    4: [function (e, t, n) {
        ...
        t.exports = function (e, t, n, i) {
            ...
            u > 0 && l > u && (l = u);
            for (let c = 0; c < l; ++c) {
                var f; var p; var h; var d; let g = e[c].replace(s, '%20');
                let m = g.indexOf(n);
    ...
    5: [function (e, t, n) {
        ...
        t.exports = function (e, t, n, s) {
            return t = t || '&', n = n || '=', null === e && (e = void 0), 'object' === typeof e ? r(a(e), function (a) {
                let s = encodeURIComponent(o(a)) + n;
    ...
    7: [function (e, t, n) {
        ...
        let v = ['/', '?', '#'];
        let y = 255;
        let b = /^[+a-z0-9A-Z_-]{0,63}$/;
        let x = /^([+a-z0-9A-Z_-]{0,63})(.*)$/;
        let w = {
            javascript: !0,
            'javascript:': !0
        };
        ...
        r.prototype.parse = function (e, t, n) {
            ...
            if (s = s.trim(), !n && 1 === e.split('#').length) {
                let f = p.exec(s);
                if (f) {
                    return this.path = s, this.href = s, this.pathname = f[1], f[2] ? (this.search = f[2], t ? this.query = k.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : t && (this.search = '', this.query = {}), this;
                }
            }
            let h = c.exec(s);
            if (h) {
            ...
            if (!C[h] && (j || h && !T[h])) {
                ...
                let D = '[' === this.hostname[0] && ']' === this.hostname[this.hostname.length - 1];
                if (!D) {
            ...
            if (e.protocol && e.protocol !== n.protocol) {
                if (!T[e.protocol]) {
                    for (let f = Object.keys(e), p = 0; p < f.length; p++) {
                        let h = f[p];
                        n[h] = e[h];
                    }
                    return n.href = n.format(), n;
            ...
            let v = n.pathname && '/' === n.pathname.charAt(0);
            let y = e.host || e.pathname && '/' === e.pathname.charAt(0);
            let b = y || v || n.host && e.pathname;
            let x = b;
            let w = n.pathname && n.pathname.split('/') || [];
            var d = e.pathname && e.pathname.split('/') || [];
            let k = n.protocol && !T[n.protocol];
            ...
            for (var E = w.slice(-1)[0], N = (n.host || e.host || w.length > 1) && ('.' === E || '..' === E) || '' === E, S = 0, A = w.length; A >= 0; A--) {
                E = w[A], '.' === E ? w.splice(A, 1) : '..' === E ? (w.splice(A, 1), S++) : S && (w.splice(A, 1), S--);
            }
            if (!b && !x) {
                for (; S--; S) {
                    w.unshift('..');
    ...
    9: [function (e, t, n) {
        function r(e) {
            let t = a(e.currentTarget).parent().find('.dropdown-menu');
    ...
    13: [function (e, t, n) {
        ...
        function u(e) {
            ...
            u = o.position().top;
            for (let l = 10, c = 0; c < l && (!i.is(n) && !i.is(i.offsetParent())); c++) {
        ...
        function l(e, t) {
            if (e || t || (e = w.first()), t && (e = w.length > 1 ? w.filter(function () {
                ...
                let n = window.location.pathname + window.location.hash;
        ...
        function f() {
            let e = r();
            let t = e.scrollTop();
            let n = e.prop('scrollHeight');
            let o = e.prop('clientHeight');
            let i = w.length;
            let a = null;
            T(w.get().reverse()).each(function (e) {
                let n; let r = c(T(this));
        ...
        function p(e, t) {
            let n = k.parse(A);
            let r = k.resolve(window.location.pathname, e);
            let i = k.parse(r);
            let a = i.hash;
            let s = i.pathname !== n.pathname;
            let u = Boolean(i.hostname);
            if (!S || u) {
            ...
            let l = T.Deferred(function (e) {
                T.ajax({
                    ...
                    success: function (n, i, s) {
                        let u = s.getResponseHeader('X-Current-Location') || r;
                        ...
                        let f = c.find('.book');
                        if (0 === f.length) {
                            let p = new Error('Invalid gitbook page, redirecting...');
                            return e.reject(p);
                        }
                        t && history.pushState({
                            path: u
                        ...
                        let g = T('.book').attr('class');
                        let m = T('.book-summary').scrollTop();
        ...
        function d(e) {
            let t = T('.book-body');
            let n = t.find('.body-inner');
            let o = n.find('.page-wrapper');
            h(), o.focus();
            let i = r();
            e !== !1 && i.scrollTop(0), w = T('.book-summary .summary .chapter').filter(function () {
                let e = T(this).children('a');
                let t = null;
                if (!e.length) {
                    return !1;
                }
                t = e.attr('href').split('#')[0];
                let n = k.resolve(window.location.pathname, t);
        ...
        function y() {
            let e = T('.navigation-next').attr('href');
            e && p(e, !0);
        }

        function b() {
            let e = T('.navigation-prev').attr('href');
            e && p(e, !0);
        }
        ...
        let w; let C; var T = e('jquery');
        var k = e('url');
        var j = e('./loading');
        var E = e('./platform');
        var N = window.gitbook;
        var S = 'undefined' !== typeof history.pushState;
        var A = location.href;
        t.exports = {
            init: x,
            goNext: y,
    ...
    15: [function (e, t, n) {
        ...
        function a(e) {
            let t = s('.book-summary');
            t.find('li').each(function () {
                let t = s(this).data('path');
                let n = null == e || e.indexOf(t) !== -1;
                s(this).toggle(n), n && s(this).parents('li').show();
            });
        }
        var s = e('jquery');
        var u = e('./platform');
        var l = window.gitbook;
        t.exports = {
            init: i,
            isOpen: o,
            toggle: r,
    ...
    16: [function (e, t, n) {
        ...
        function u(e) {
            let t; let n = p('.book-header');
            let r = n.find('h1');
            let i = 'pull-' + e.position;
            let s = p('<a>', {
                class: 'btn',
                text: e.text ? ' ' + e.text : '',
                'aria-label': e.label,
            ...
            if (s.click(e.onClick), e.icon && p('<i>', {
                ...
                s.addClass(i), s.addClass(e.className), t = s;
            }
